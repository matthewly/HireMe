...
with open('../client/public/data/'+location+'internship.json', 'w') as outfile:
	...
	for request in range(1):
		...
		r = requests.get('https://www.googleapis.com/customsearch/v1?q=(developer+OR+software)+AND+%22'+location.replace(" ", "+")+'%22&cx=007494023296931513621%3Awwnjyngqucm&exactTerms=intern+OR+internship&start='+start+'&key=AIzaSyASVujTnW38PIlTZs9dbbEiGHiGs29Ixlo').json()

...
with open('./client/public/data/'+location+'fulltime.json', 'w') as outfile:
	...
	for request in range(10):
		...
		r = requests.get('https://www.googleapis.com/customsearch/v1?q=software+OR+engineer+OR+developer+Chicago&cx=007494023296931513621%3Awwnjyngqucm&start='+start+'&key=AIzaSyASVujTnW38PIlTZs9dbbEiGHiGs29Ixlo').json()
